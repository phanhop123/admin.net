namespace WebOnline.Migrations
{
    ...
    public partial class CreatedDatabse : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Descriptione = c.String(maxLength: 500),
                        Image = c.String(maxLength: 500),
                        Link = c.String(maxLength: 500),
                        Type = c.Int(nullable: false),
                        CreateBy = c.String(),
                        CreateDate = c.DateTime(nullable: false),
                        ModfiedDate = c.DateTime(nullable: false),
                        Modfiedby = c.String(),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Title = c.String(),
                        Descriptione = c.String(),
                        Position = c.Int(nullable: false),
                        SeoTitle = c.String(),
                        SeoKeywords = c.String(),
                        SeoDescriptione = c.String(),
                        ModifierBy = c.Int(nullable: false),
                        CreateBy = c.String(),
                        CreateDate = c.DateTime(nullable: false),
                        ModfiedDate = c.DateTime(nullable: false),
                        Modfiedby = c.String(),
                ...
                c => new
                    {
                        ...
                        SeoTitle = c.String(),
                        SeoDescriptione = c.String(),
                        SeoKeywords = c.Int(nullable: false),
                        CreateBy = c.String(),
                        CreateDate = c.DateTime(nullable: false),
                        ModfiedDate = c.DateTime(nullable: false),
                        Modfiedby = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_OderDetail", "OrderId", "dbo.tb_Order");
            ...
            DropIndex("dbo.tb_OderDetail", new[] { "OrderId" });
